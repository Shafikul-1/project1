...
<nav class="bg-white border-gray-200 dark:bg-gray-900">
  ...
  <a href="#" class="flex items-center">
      <img src="https://img.icons8.com/?size=2x&id=pT5UBaK8aOM_&format=png" class="h-8 mr-3" alt="Flowbite Logo" />
      <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Flowbite</span>
  </a>
  <div class="flex items-center md:order-2 relative">
    <div class="relative mt-3 mr-5">
      ...
      <button @click="profileShow()" type="button" class="flex mr-3 text-sm bg-gray-800 rounded-full md:mr-0 focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600" id="user-menu-button" aria-expanded="false" data-dropdown-toggle="user-dropdown" data-dropdown-placement="bottom">
        <span class="sr-only">Open user menu</span>
        <img class="w-8 h-8 rounded-full" src="https://img.icons8.com/?size=2x&id=rzNUpIIEqimt&format=png" alt="user photo">
      </button>
      <!-- Dropdown menu -->
      <div v-show="userProfile" class="absolute top-7 right-0 z-50  my-4 text-base list-none bg-white divide-y divide-gray-100 rounded-lg shadow dark:bg-gray-700 dark:divide-gray-600" id="user-dropdown">
        <div class="px-4 py-3">
  ...
  <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-user">
    ...
    <ul class="flex flex-col font-medium p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
      ...
      <li class="relative">
        ...
        <ul v-show="dropdownAbout" class="absolute list-none py-3 right-[-2rem] bg-gray-200">
          <li class="hover:bg-gray-100 px-4 my-2">
            <a href=""  class="hover:text-indigo-500">Home</a>
          </li>
          <li class="hover:bg-gray-100 px-4 my-2">
            <a href="" class="hover:text-indigo-500">Blog</a>
          </li>
          <li class="hover:bg-gray-100 px-4 my-2">
            <a href="" class="hover:text-indigo-500">Portfolio</a>
          </li>
        </ul>
      </li>
      <li>
        <a href="#" class="block py-2 pl-3 pr-4 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">Test</a>
      </li>
      <li>
